...
---
This library aims to help you develop function calling capabilities for your functions and build applications such as Agents, Chatbots and more with it.
...
<CardGroup cols={2}>
  ...
  >
    Feel free to email questions and feedback
  </Card>
</CardGroup>
